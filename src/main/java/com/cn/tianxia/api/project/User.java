package com.cn.tianxia.api.project;
...
public class User {
	...
	public void setIs_daili(int is_daili) {
	...
	public String getQk_pwd() {
		return qk_pwd;
	}

	public void setQk_pwd(String qk_pwd) {
		this.qk_pwd = qk_pwd;
	}
	...
	public double getAg_money() {
		return ag_money;
	}

	public void setAg_money(double ag_money) {
		this.ag_money = ag_money;
	}
