...
public class IPAddressUtils {
        ...
        try {
            ...
            try {
               ...
               // String filename = new File(IP_FILE).getName().toLowerCase();
                String filePath = IPAddressUtils.class.getClassLoader().getResource("/ip.dat").getPath();
    ...
    public static void main(String[] args){
        ...
        ip.init();
        String address = "2001:DB8:0:23:8:800:200C:417A";
